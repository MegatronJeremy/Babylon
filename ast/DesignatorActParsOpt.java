...
public class DesignatorActParsOpt extends DesignatorStatement {

    private Designator Designator;
    private ActParsOpt ActParsOpt;

    public DesignatorActParsOpt (Designator Designator, ActParsOpt ActParsOpt) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorActParsOpt(\n");
