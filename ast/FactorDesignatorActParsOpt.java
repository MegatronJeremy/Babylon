...
public class FactorDesignatorActParsOpt extends Factor {

    private Designator Designator;
    private ActParsOpt ActParsOpt;

    public FactorDesignatorActParsOpt (Designator Designator, ActParsOpt ActParsOpt) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FactorDesignatorActParsOpt(\n");
