...
public class ConstructorDeclList implements SyntaxNode {
    ...
    public ConstructorDeclList (ConstructorDeclList ConstructorDeclList, ConstructorDecl ConstructorDecl) {
